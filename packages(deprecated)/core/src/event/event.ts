import { type CacheType, type IEventParams, type IEventOptions } from '@sunshine-track/types';
import { getTimestamp, warning } from '@sunshine-track/utils';
import { __sunshine_track__ } from '@sunshine-track/utils';
import { isPlainObject, cloneDeep } from 'lodash-es';
import { db, storage } from '../setup/cache/cache';
import { DB_EVENT_STORE_NAME } from '@sunshine-track/configs';
